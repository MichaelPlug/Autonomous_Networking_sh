...
#python3 -m src.experiments.json_and_plot -nd 5 -nd 10 -nd 15 -i_s 1 -e_s 3 -exp_suffix GEO -exp_suffix RND -exp_suffix CLO -exp_suffix EGN -exp_suffix GEOUP -exp_suffix RND_RL -exp_suffix EGSOLOID -exp_suffix UCB -exp_suffix AI
